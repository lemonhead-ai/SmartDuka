...
export type Duka = { id: string; name: string; category: string; theme: "sunrise" | "ocean" | "leaf" | "berry" | "charcoal"; cash_balance_kes: number; items: (CatalogItem & { stock: number; restock_cost_kes: number })[] };
