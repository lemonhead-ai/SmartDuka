...
async def main():
    ...
    ctx = AgentContext(
        ...
        chat_history=[
            ChatMessageContext(sender="shopkeeper", message="I only have 1 juice left. Would you like to take that amount instead?"),
            ChatMessageContext(sender="customer", message="I can take what you have today, thank you."),
            ChatMessageContext(sender="shopkeeper", message="okay thank you, i added the requested items"),
        ],
    )
